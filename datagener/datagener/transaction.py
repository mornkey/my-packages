...
def get_names(n_rec):
    lineList = [line.rstrip('\n') for line in open('/home/nontapat/Documents/my packages/datagener/names.txt')]
    name_list = random.choices(lineList, k=n_rec)
    return name_list

def get_emails(name_list):
    company_name_list = random.choices([line.rstrip('\n') for line in open('/home/nontapat/Documents/my packages/datagener/company-names.txt')], k=len(name_list))
